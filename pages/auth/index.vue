            ...
            <div>
                <Form :validation-schema="validateSchema" @submit="handleLogin">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            <NuxtLink to="/auth/reset" class="text-[#4A52E6] underline">Forgot Password?</NuxtLink>
                        </div>
                    </div>
                    <div class="mt-4">
                        <button type="submit" class="bg-[#4A52E6] py-2 px-1 text-white rounded-xl w-full text-lg shadow-[0px_4px_0px_-1px_#000000] border border-black">Sign In</button>
                        <h3 class="text-gray-600 text-center mt-6">Don't have an account? <NuxtLink to="/auth/signup" class="text-blue-600">Sign Up</NuxtLink></h3>
                    </div>
                </Form>
            </div>
        </div>
